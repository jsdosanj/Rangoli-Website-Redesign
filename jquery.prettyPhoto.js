...
(function($) {
	...
	$.fn.prettyPhoto = function(settings) {
		settings = jQuery.extend({
			...
			flash_markup: '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="{width}" height="{height}"><param name="wmode" value="{wmode}" /><param name="allowfullscreen" value="true" /><param name="movie" value="{path}" /><embed src="{path}" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="{width}" height="{height}" wmode="{wmode}"></embed></object>',
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(images[setPosition])){
					...
					case 'youtube':
						...
						//added code so that it uses the new youtube player version
					    movie += "&version=3";
					    //hide related videos
					    movie += "&rel=0"
					    //hide titles
						...
						//document.form1.box.value = toInject;
					break;
